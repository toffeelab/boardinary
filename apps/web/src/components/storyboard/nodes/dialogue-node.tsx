...
function DialogueNodeComponent({ data, selected }: NodeProps) {
  ...
  return (
    <div
      ...
      style={{
        minWidth: 180,
        borderLeftColor: nodeData.color ?? "#3b82f6",
        borderLeftWidth: 4,
      }}
    >
      <NodeResizer
      ...
      <div className="flex items-center gap-2 mb-1">
        <span className="text-xs font-medium text-blue-500">대사</span>
      </div>
      {nodeData.speaker && (
...
export const DialogueNode = memo(DialogueNodeComponent);
